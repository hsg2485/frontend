/*
    자바스크립트 객체 : 원시값(number,string,boolean,undefined,null 등) 을 제외한 함수,배열도 객체 object 입니다.
...
//JSON.parse 메소드는 JSON 문자열을 자바 스크립트 객체로 변환. 서버에서 전송받은 데이터를 처리하기 위해 객체로 변환
